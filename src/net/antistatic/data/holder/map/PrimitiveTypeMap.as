...
import net.antistatic.data.holder.map.AbstractMap;
import net.antistatic.data.holder.map.ValueMapIterator;
import net.antistatic.data.holder.map.KeyMapIterator;
 ...
 * @author Simon Wacker
 */
public class PrimitiveTypeMap extends AbstractMap implements IMap {
	 ...
	 * map with
	 */
	public function PrimitiveTypeMap(source:* = null) {
		map = new Object();
		indexMap = new Object();
	...
	public function remove(key:*):* {
		...
		if (indexMap[key] != undefined) {
			...
			for (var k:uint = i; k < keys.length; k++) {
				indexMap[keys[k]]--;
			}
		}
		return result;
